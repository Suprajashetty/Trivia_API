...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_question = {
            'question' : "How many laws are there in Newtons law?",
            'answer' :"3",
            'category' : 'Science',
            'difficulty' : 1
        }
    ...
    def test_get_question_search_without_results(self):
        res = self.client().post("/questions/search", json={"search": "mango"})
        data = json.loads(res.data)
    ...
    def test_questions_to_play_quiz(self):
        new_quiz_round = {'previous_questions': [28], 'quiz_category': {'type': 'Entertainment', 'id': 6}}
